...
synth_design -top test_uart -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef test_uart.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file test_uart_utilization_synth.rpt -pb test_uart_utilization_synth.pb"  } 
