...
HD_PWD='C:/Facultate/An_3/Semestrul_2/proiecte/Proiect_uart_spi/UART_SPI/UART_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_uart.tcl
